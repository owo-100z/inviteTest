...
//   banks = [],
  ...
  const banks = [
    {code: '002', logo: '/inviteTest/banks/002.png', name: 'KDB산업은행'},
    {code: '003', logo: '/inviteTest/banks/003.png', name: 'IBK기업은행'},
    {code: '004', logo: '/inviteTest/banks/004.png', name: 'KB국민은행'},
    // {code: '005', logo: '/inviteTest/banks/005.png', name: 'KEB하나은행'},
    {code: '007', logo: '/inviteTest/banks/007.png', name: '수협은행'},
    {code: '011', logo: '/inviteTest/banks/011.png', name: 'NH농협은행'},
    {code: '020', logo: '/inviteTest/banks/020.png', name: '우리은행'},
    {code: '023', logo: '/inviteTest/banks/023.png', name: 'SC은행'},
    {code: '027', logo: '/inviteTest/banks/027.png', name: '씨티은행'},
    {code: '031', logo: '/inviteTest/banks/031.png', name: '대구은행'},
    {code: '032', logo: '/inviteTest/banks/032.png', name: '부산은행'},
    {code: '034', logo: '/inviteTest/banks/034.png', name: '광주은행'},
    {code: '035', logo: '/inviteTest/banks/088.png', name: '제주은행'},
    {code: '037', logo: '/inviteTest/banks/037.png', name: '전북은행'},
    {code: '039', logo: '/inviteTest/banks/032.png', name: '경남은행'},
    {code: '045', logo: '/inviteTest/banks/045.png', name: 'MG새마을금고'},
    {code: '048', logo: '/inviteTest/banks/048.png', name: '신협'},
    {code: '050', logo: '/inviteTest/banks/050.png', name: '저축은행'},
    {code: '064', logo: '/inviteTest/banks/064.png', name: '산림조합'},
    {code: '071', logo: '/inviteTest/banks/071.png', name: '우체국'},
    {code: '081', logo: '/inviteTest/banks/005.png', name: '하나은행'},
    {code: '088', logo: '/inviteTest/banks/088.png', name: '신한은행'},
    {code: '089', logo: '/inviteTest/banks/089.png', name: '케이뱅크'},
    {code: '090', logo: '/inviteTest/banks/090.png', name: '카카오뱅크'},
    {code: '092', logo: '/inviteTest/banks/092.png', name: '토스뱅크'},
    {code: '103', logo: '/inviteTest/banks/103.png', name: 'SBI저축은행'},
    // 증권 사용X
